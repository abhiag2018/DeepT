...
include { prep_gen_seq } from './Genomic_seq_reg_elem'
...
// hic_split_num = params.dev ? 1 : params.hic_split_process
...
//     // ch_hic_gtfed = COMBINE_PROMOTERS(ch_hic_matched.flatten(), ch_gtf_input)
