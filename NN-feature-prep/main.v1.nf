...
include { promoter_bed; enhancer_bed } from "${params.baseDir}/code/NN-feature-prep/modules/pr-enh-prep" // step 1
include { prep_co_score_enh; prep_co_score_pr } from "${params.baseDir}/code/NN-feature-prep/modules/co-score-prep" // step 2
include { prep_pchic } from "${params.baseDir}/code/NN-feature-prep/modules/pchic-prep" // step 4
include { prep_gen_seq } from "${params.baseDir}/code/NN-feature-prep/modules/genome-seq-prep" // step 3
